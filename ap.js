...
/*_______________________________  Question no 46 ____________________________________
add delete localstorage
/*________________________ Answer ____________________________________ */
// function addData(){let get = document.getElementById('userinput').value;
//     console.log(get, typeof get);
//     localStorage.setItem('mydata',get);
//     let converString = JSON.stringify(get);
//     console.log(converString, typeof converString)
    
//     document.getElementById('display').innerHTML = get;
// }
// function deleting(){document.getElementById('display').innerHTML = '';}

/*_______________________________  Question no 47 ____________________________________

/*________________________ Answer ____________________________________ */
// Initial data (you can remove this if data already exists)
// let employee = {
//   name: "Ali",
//   age: 30,
//   email: "ali@example.com"
// };
// localStorage.setItem('myinfo', JSON.stringify(employee));
...
//   if (!data) {
//     display.innerHTML = 'No data in localStorage.';
//     return;
//   }
...
//   for (let key in obj) {
//     display.innerHTML += `${key}: ${obj[key]}<br>`;
//   }

//   // Show delete buttons for each key
//   for (let key in obj) {
//     let btn = document.createElement('button');
//     btn.innerText = `Delete ${key}`;
...
//   showData(); // Refresh view
// }

// // Show data on page load
// showData();

/*_______________________________  Question no 48 ____________________________________
Create a Mini Program
Question:
Build a small program where:

var is used to store your name

let is used to store your age (which might change)

const is used to store your country (which won’t change)
Then print all values and try to reassign them.

Expected Output:
Understand which value can be updated or not, and where errors appear.
/*________________________ Answer ____________________________________ */
//  var name = 'Aziz';
//       name = 'khan';
//  let age = 30;
...
/*_______________________________  Question no 49 ____________________________________
: Exponent Table
Question:
Use a for loop to print powers of 2 from 2^1 to 2^10.
...
/*________________________ Answer ____________________________________ */
 ...
 for(let i = 1 ; i <= 10; i++){let result = 2 **i;
   document.getElementById('display').innerHTML = document.getElementById('display').innerHTML + `2* ${i} = ${result} <br>`
   
  
 }

/*_______________________________  Question no 50 ____________________________________

className style applying practice
/*________________________ Answer ____________________________________ */
